 ...
 */
/*@EnableWebSecurity
public class WebSecurityConfig<JwtTokenGenerator> extends WebSecurityConfigurerAdapter {
    ...
    *//**
    ...
    private CustomJSONLoginFilter customJSONLoginFilter() {
        CustomJSONLoginFilter customJSONLoginFilter = new CustomJSONLoginFilter("/login", userInfoService);
        ...
        System.out.println(customJSONLoginFilter);
